...
export default function Hero() {
  return (
    <section id="top" style={{ paddingTop: 96 }}>
      <div className="wrap">
        <Reveal delay={0}><p className="eyebrow">{hero.eyebrow}</p></Reveal>
        <Reveal delay={110}>
        ...
        <Reveal delay={220}>
          <p className="eyebrow" style={{ marginTop: 26 }}>{hero.credentials}</p>
        </Reveal>
        <Reveal delay={320}>
          <div style={{ height: 1, background: 'var(--wash)', margin: '34px 0 26px' }} />
        </Reveal>
        <Reveal delay={400}>
          <p className="lede">
        ...
        <Reveal delay={600}>
          <div className="links" style={{ marginTop: 44 }}>
